      ...
      >
        ...
        <div className="relative z-10 max-w-5xl px-6 text-center mt-12">
          ...
          >
            ...
            production, KAYTEX-EXPORTERS helps global brands develop premium loungewear
            designed around comfort, quality, and their unique brand direction.
          </p>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="font-serif text-xl sm:text-2xl md:text-3xl font-light uppercase tracking-wide text-white leading-relaxed mb-6 statement-anim opacity-0">
            KAYTEX-EXPORTERS is a full-service loungewear manufacturer and export partner
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-3xl mb-20 md:mb-28">
            ...
            <p className="text-sm font-light text-white/70 tracking-wide leading-relaxed">
              From the first product concept to finished garments, KAYTEX-EXPORTERS
              supports the key stages required to develop and manufacture
              loungewear for growing brands.
            </p>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-3xl mb-20 md:mb-28">
            ...
            <p className="text-sm font-light text-white/70 tracking-wide leading-relaxed">
              Explore the loungewear categories KAYTEX-EXPORTERS can support across
              different comfort, lifestyle, and collection requirements.
            </p>
          </div>
      ...
      <section className="relative w-full bg-[#111111] border-t border-[#2a2a2a] py-24 md:py-36 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl px-6 mx-auto">
          ...
          <p className="text-xs md:text-sm font-light text-white/50 tracking-wide max-w-md mx-auto mb-12 leading-relaxed">
            ...
            KAYTEX-EXPORTERS and explore a manufacturing partnership built around quality,
