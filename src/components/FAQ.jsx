...
const faqData = [
  {
    id: "faq-1",
    question: "What is KAYTEX-EXPORTERS?",
    answer:
      "KAYTEX-EXPORTERS is a specialized women’s garment exporter, delivering premium-quality apparel crafted for global fashion brands. We focus on reliable production, refined craftsmanship, and export-ready quality tailored to every brand’s unique requirements.",
  },
  {
    id: "faq-2",
    question: "What items do you manufacture?",
    answer:
      "KAYTEX-EXPORTERS specializes in manufacturing and exporting premium women’s garments for fashion brands and retailers worldwide. From design-focused development to precise production, we deliver quality, consistency, and export-ready apparel tailored to every brand’s requirements.",
  },
  {
    id: "faq-3",
