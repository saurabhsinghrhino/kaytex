...
export const WhatsAppButton = () => {
  ...
  // Smooth entrance animation using existing GSAP setup
  useGsap(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0, scale: 0.8, y: 20 },
      {
        ...
        duration: 0.6,
        ease: "power3.out",
        delay: 0.8, // Subtle delay to let the page load before displaying
      },
    );
  }, []);
  ...
  return (
    <aside
      ref={buttonRef}
      className="fixed bottom-5 right-5 sm:bottom-7 sm:right-7 z-50 flex items-center gap-3 opacity-0 group"
    >
