    ...
    >
      ...
      >
        ...
        <p className="max-w-xl mx-auto text-sm md:text-base font-light tracking-wide text-white/70 leading-relaxed">
          From the selection of extra-long staple organic fibers to our
          12-stitches-per-inch sewing standard, every phase of production is
          monitored. You can visually see and tactfully feel the weight,
          consistency, and structure of a kaytex-EXPORTERS garment.
        </p>
